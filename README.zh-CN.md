...
| **🧭 你的决策塑造她** | 夸她 → 更暖更爱表达；重做 → 更严谨；打断 → 学着简短。阻尼让她的底色不被轻易改变 |
| **📚 每天联网自学** | 每天上网（Firecrawl）读新东西，消化进记忆与日记——知识日积月累 |
| **🛠️ 无限工具的壳子** | 开源 "skills" 是装好的工具；我们做的是那个能无限安装工具的壳子——MCP、工具框架、marathon 自迭代，她需要什么能力就长出什么能力 |
