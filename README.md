...
└── personality.json # 性格（出生随机 Roll，随你们相处缓慢漂移——你看不到数值，只感受得到她）
```
...
| **🧠 记忆** | 学的主题沉淀进 memory.md，她越来越了解你的世界 |
| **🧬 性格** | 出生时随机 Roll 一次，随相处自然演化：你夸她她更爱表达、重做她更严谨、打断她学着简短（阻尼 + 守恒，她不会变形）——数字永远藏起来 |
